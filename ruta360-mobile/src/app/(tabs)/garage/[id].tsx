...
const StatusRing = ({ status, color, icon }: { status: string, color: string, icon: keyof typeof MaterialIcons.glyphMap }) => (
  <View style={styles.statusRingContainer}>
    <Svg width="48" height="48" viewBox="0 0 36 36" style={{ transform: [{ rotate: '-90deg' }] }}>
      ...
      <Circle cx="18" cy="18" r="16" stroke={color} strokeWidth="3" fill="none" strokeDasharray="100, 100" strokeDashoffset={status === 'ok' ? 0 : 35} strokeLinecap="round" />
    </Svg>
...
export default function GarageDetailScreen() {
  ...
  const soatColor = moto.soat_status === 'ok' ? Colores.primario : Colores.acento;
  const tecnoColor = moto.tecno_status === 'ok' ? Colores.primario : Colores.acento;
          ...
          <View style={styles.grid}>
            <View style={styles.docCard}>
              <StatusRing 
                ...
                color={soatColor} 
                icon={moto.soat_status === 'ok' ? 'verified' : 'warning'} 
              />
              <View>
                ...
                <Text style={[styles.docStatus, { color: soatColor }]}>
                  {moto.soat_status === 'ok' ? 'AL DÍA' : 'PENDIENTE'}
                </Text>
              </View>
            </View>
            ...
            <View style={styles.docCard}>
              <StatusRing 
                ...
                color={tecnoColor} 
                icon={moto.tecno_status === 'ok' ? 'verified' : 'warning'} 
              />
              <View>
                ...
                <Text style={[styles.docStatus, { color: tecnoColor }]}>
                  {moto.tecno_status === 'ok' ? 'AL DÍA' : 'PREVENTIVO'}
                </Text>
              </View>
            </View>
          </View>
