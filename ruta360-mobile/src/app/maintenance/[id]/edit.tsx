...
import MaintenanceForm, { MaintenanceFormData } from '@/components/maintenance/MaintenanceForm';
...
export default function EditMaintenanceScreen() {
  ...
  const { records, updateMaintenanceRecord, deleteMaintenanceRecord } = useMaintenanceStore();
  ...
  const handleSave = async (formData: MaintenanceFormData, totalCost: number) => {
