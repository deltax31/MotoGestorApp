...
export default function MaintenanceListScreen() {
  ...
  const { activeMotorcycleId, setActiveMotorcycle, motorcycles } = useGarageStore();
  const { records, isLoading, fetchMaintenanceRecords } = useMaintenanceStore();
            ...
            <View style={styles.tabContent}>
              <View style={styles.emptyNextCard}>
                <View style={styles.emptyNextIcon}>
                  <MaterialIcons name="event-upcoming" size={32} color="rgba(255,255,255,0.2)" />
                </View>
