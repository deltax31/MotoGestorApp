...
import { useFinanceStore, ExpenseItem } from '@/store/financeStore';
...
export default function EditExpenseScreen() {
  ...
  const { transactions, updateExpense } = useFinanceStore();
  ...
  const handleSubmit = async () => {
    ...
    const primaryCategory = items.length === 1 ? items[0].category : 'Múltiple';
