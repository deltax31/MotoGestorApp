...
export interface BikeCarouselItem {
  id: string;
  name: string;
  plate: string;
  km: number;
...
interface BikeCarouselProps {
  bikes: BikeCarouselItem[];
  activeId?: string | null;
  onActiveItemChange?: (id: string) => void;
}

export function BikeCarousel({ bikes, activeId, onActiveItemChange }: BikeCarouselProps) {
  ...
  return (
    <View style={styles.container}>
      ...
      >
        {bikes.map((bike) => (
          <View key={bike.id} style={styles.cardContainer}>
