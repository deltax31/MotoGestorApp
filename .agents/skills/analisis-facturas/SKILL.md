---
name: analisis-facturas
description: Skill experta en extracción y análisis de datos de facturas de talleres de motos en Colombia, incluyendo formatos comunes, IVA, retención y detección de cobros irregulares.
---
