...
description: Skill experta en análisis de gastos de motocicleta, detección de patrones de consumo, optimización de presupuesto y proyección de costos futuros para el módulo de Finanzas.
---
