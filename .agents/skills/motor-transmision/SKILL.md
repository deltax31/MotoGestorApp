---
name: motor-transmision
description: Skill experta en motores de motocicleta (2T/4T), sistemas de transmisión, embrague, sistemas de alimentación (carburador e inyección) y diagnóstico de problemas internos del motor.
---
