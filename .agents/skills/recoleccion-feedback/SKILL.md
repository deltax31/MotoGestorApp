---
name: recoleccion-feedback
description: Skill para detectar insatisfacción del usuario, recopilar feedback de forma natural durante la conversación y generar insights accionables para los dueños de la app.
---
