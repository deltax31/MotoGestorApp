---
name: diagnostico-por-sintomas
description: Skill experta en diagnóstico de fallas mecánicas en motocicletas a partir de síntomas descritos por el usuario (ruidos, vibraciones, humo, olores, comportamiento anormal).
---
